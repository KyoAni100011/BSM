...
insert user (id, name, email, password, dob, telephone) values ('11110001', 'Minh Thu', 'thu.admin@bms.com', '$2a$12$4USYbZyH0x77oZgTd2Oji.C3aJXgkb3K8PmYP3o47TUS6I3Vt03wG
', '2003-06-01', '0101012345'); -- password: 01062003
    insert user (id, name, email, password, dob, telephone) values ('11110002', 'Hoang Kha', 'kha.admin@bms.com', '$2a$12$vdz7/qrIG4Fb1Z5YHzYEX.5sImzChCKjr6Sb88dEpTZCqZcJhb1Gi
...
insert into book (isbn, title, publisherID, publishingDate, language)
values ('66661111', 'Toi thay hoa vang tren co xanh', @publisherID, '2015-01-01', 'Vietnamese');
...
values ('Harry Potter Va Chiec Coc Lua', @publisherID, '2018-01-01', 'English');
...
insert into book (title, publisherID, publishingDate, language)
values ('Giao thua', @publisherID, '2020-01-01', 'Vietnamese');
...
set @publisherID = (select id from publisher where name = 'Nha Nam');
insert into book (title, publisherID, publishingDate, language)
values ('The Tell-Tale Heart', @publisherID, '2020-04-12', 'English');
...
set @publisherID = (select id from publisher where name = 'Nha Nam');
insert into book (title, publisherID, publishingDate, language)
values ('Pride and Prejudice', @publisherID, '2019-10-21', 'English');
...
set @publisherID = (select id from publisher where name = 'Nha Nam');
insert into book (title, publisherID, publishingDate, language)
values ('Wolf Hall', @publisherID, '2020-11-11', 'English');
...
set @publisherID = (select id from publisher where name = 'Nha Nam');
insert into book (title, publisherID, publishingDate, language)
values ('Experience and Education', @publisherID, '2017-04-13', 'English');
...
set @publisherID = (select id from publisher where name = 'Nha Nam');
insert into book (title, publisherID, publishingDate, language)
values ('Thinking, Fast and Slow', @publisherID, '2020-06-07', 'English');
...
set @publisherID = (select id from publisher where name = 'Nha Nam');
insert into book (title, publisherID, publishingDate, language)
values ('Astrophysics for People in a Hurry', @publisherID, '2018-09-09', 'English');
...
insert into bookBatch(quantity, importPrice, importSheetID, bookID) values (100, 70000, @importSheetID, @bookID);
...
insert into bookCategory (bookID, categoryID) values (@bookID, @categoryID);
insert into bookBatch(quantity, importPrice, importSheetID, bookID)  values (200, 200000, @importSheetID, @bookID);
...
set @categoryID = (select id from category where name = 'Short Stories');
insert into bookCategory (bookID, categoryID) values (@bookID, @categoryID);
insert into bookBatch(quantity, importPrice, importSheetID, bookID)  values (300, 55000, @importSheetID, @bookID);
...
insert into bookCategory (bookID, categoryID) values (@bookID, @categoryID);
insert into bookBatch(quantity, importPrice, importSheetID, bookID)  values (100, 30000, @importSheetID, @bookID);
update importSheet set quantity = quantity + 100 where id = @importSheetID;
...
set @categoryID = (select id from category where name = 'Novel');
insert into bookCategory (bookID, categoryID) values (@bookID, @categoryID);
insert into bookBatch(quantity, importPrice, importSheetID, bookID)  values (150, 80000, @importSheetID, @bookID);
...
insert into bookCategory (bookID, categoryID) values (@bookID, @categoryID);
insert into bookBatch(quantity, importPrice, importSheetID, bookID)  values (100, 100000, @importSheetID, @bookID);
update importSheet set quantity = quantity + 100 where id = @importSheetID;
...
insert into bookCategory (bookID, categoryID) values (@bookID, @categoryID);
insert into bookBatch(quantity, importPrice, importSheetID, bookID)  values (200, 120000, @importSheetID, @bookID);
update importSheet set quantity = quantity + 200 where id = @importSheetID;
...
insert into bookCategory (bookID, categoryID) values (@bookID, @categoryID);
insert into bookBatch(quantity, importPrice, importSheetID, bookID)  values (150, 150000, @importSheetID, @bookID);
update importSheet set quantity = quantity + 150 where id = @importSheetID;
